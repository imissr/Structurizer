...
public class GenerateC4ModelCompFinder {
    public static void main(String[] args) throws Exception {
        ...
        try (InputStream input = new FileInputStream("C:\\Users\\khale\\IdeaProjects\\Test_Spring_Project\\src\\main\\resources\\application.properties")) {
            props.load(input);
        }
        ...
        ComponentFinder componentFinder = new ComponentFinderBuilder()
                .forContainer(webApp)
                .fromClasses(new File("C:\\Users\\khale\\IdeaProjects\\spring-petclinic"))
                .withStrategy(
